...
集成了最新的技术栈包括`babel7,autoprefixer,less,postcss,webpack5`、高度封装、简化配置、无多余依赖、具有服务启动、开发调试、代理访问、数据模拟、构建资源、自动刷新功能。快速开发UCF微服务工程底层配套工具支撑，[详情文档](https://www.yuque.com/ucf-web/book/zfy8x1)
...
babel_include | `babel`使用的 incluede | [] | (includes) => includes / array | 当在ie内存在如第三方包代码不兼容情况时 可在此配置解决

...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getEndValue = function () {
    var _state4 = _this2.state,
        ...
        endYearMonth = _state4.endYearMonth;

    var endValue = value[1] ? value[1].clone() : endYearMonth ? endYearMonth.clone() : value[0].clone().add(1, 'month');
    // keep selectedTime when select date
  ...
  this.fireSelectValueChange = function (selectedValue, direct, cause) {
    ...
    var _state6 = _this2.state,
        prevSelectedValue = _state6.prevSelectedValue,
        endYearMonth = _state6.endYearMonth;
    ...
    if (!_this2.state.selectedValue[0] || !_this2.state.selectedValue[1]) {
      ...
      var endValue = selectedValue[1] || (endYearMonth ? endYearMonth.clone() : startValue.clone().add(1, 'months'));
      _this2.setState({
        selectedValue: selectedValue,

...
//TODO
.rc-calendar-year-panel-disabled-cell {
...
.datepicker-input-group.u-input-group:hover{
  & > input {
    border-color: #66afe9;
  }
...
.calendar-picker.u-input-group:hover{
  & > input {
    border-color: #66afe9;
  }
  & > .u-form-control[disabled]{
...
// u-table 单元格中的 DatePicker
.u-table-tbody {
  th.rc-calendar-column-header {
    padding: 6px 0;
    text-align: center;
  }
  td.rc-calendar-cell {
  ...
  .rc-calendar-year-select, .rc-calendar-month-select, .rc-calendar-today-btn, .rc-calendar-next-month-btn, .rc-calendar-next-year-btn, .rc-calendar-prev-month-btn, .rc-calendar-prev-year-btn,
  .rc-calendar-year-panel-decade-select, .rc-calendar-year-panel-prev-decade-btn, .rc-calendar-year-panel-next-decade-btn, 
  .rc-calendar-decade-panel-prev-century-btn, .rc-calendar-decade-panel-next-century-btn,
  .rc-calendar-month-panel-year-select, .rc-calendar-month-panel-prev-year-btn, .rc-calendar-month-panel-next-year-btn {
    color: #212121;
    &:hover {
      color: #e60012;
    }
  }
  .rc-calendar-year-panel-year, .rc-calendar-decade-panel-decade, .rc-calendar-month-panel-month {
    color: #212121;
  }
  .rc-calendar-year-panel-selected-cell .rc-calendar-year-panel-year,
  .rc-calendar-decade-panel-selected-cell .rc-calendar-decade-panel-decade,
...
.u-table .u-table-scroll tr {
  td.rc-calendar-cell:first-child, th.rc-calendar-column-header:first-child {
    padding-left: 0;
  }
}

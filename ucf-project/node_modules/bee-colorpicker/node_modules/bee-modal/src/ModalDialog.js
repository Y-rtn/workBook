...
class ModalDialog extends React.Component {
  ...
  onStart = event => {
    ...
    let leftNum = parseInt(window.getComputedStyle(transfromDom,null).getPropertyValue('margin-left')) + parseInt(window.getComputedStyle(transfromDom,null).getPropertyValue('padding-left'));
    let topNum = parseInt(window.getComputedStyle(transfromDom,null).getPropertyValue('margin-top')) + parseInt(window.getComputedStyle(transfromDom,null).getPropertyValue('padding-top'));
    if((!transform || transform == 'translate(0px, 0px)' || transform == 'translate(0px)' || this.resized) && leftNum === 0 && topNum === 0) {

...
.u-tree {
  ...
  .u-tree li {
    ...
    .u-tree li:last-child {
      padding-bottom: 0; }
  .u-tree li span[draggable],
  .u-tree li span[draggable="true"] {
  ...
  .u-tree li.drag-over > span[draggable] {
    background-color: #108ee9;
    color: white;
    opacity: 0.8;
    position: relative; }
  .u-tree li.drag-over-gap-top > span[draggable] {
    border-top: 2px #108ee9 solid;
    position: relative;
    border-radius: 0; }
    .u-tree li.drag-over-gap-top > span[draggable]::before {
      position: absolute;
      top: -6px;
      left: -8px;
      content: ' ';
      ...
      border-radius: 99px;
      opacity: 1; }
  .u-tree li.drag-over-gap-bottom > span[draggable] {
    border-bottom: 2px #108ee9 solid;
    position: relative;
    border-radius: 0; }
    .u-tree li.drag-over-gap-bottom > span[draggable]::before {
      position: absolute;
      bottom: -6px;
      left: -8px;
      content: ' ';
      ...
      border-radius: 99px;
      opacity: 1; }
  .u-tree li.filter-node > span.u-tree-node-content-wrapper {
    color: #f50;
    font-weight: bold; }
  .u-tree li ul {
    margin: 0;
    padding: 0 0 0 18px; }
  .u-tree li span.u-tree-node-content-wrapper {
    display: inline-block;
    padding: 3px 4px;
    border-radius: 2px;
    margin: 0;
    ...
    width: calc(100%); }
  .u-tree li .u-tree-checkbox + span.u-tree-node-content-wrapper {
    width: calc(100% - 40px); }
  .u-tree li span.u-tree-node-content-wrapper:hover {
    background-color: rgb(235, 236, 240); }
  .u-tree li span.u-tree-node-selected {
    background-color: rgb(255, 247, 231); }
    .u-tree li span.u-tree-node-selected .u-tree-title {
      color: rgb(245, 60, 50); }
  .u-tree li.u-tree-treenode-focused > span.u-tree-node-content-wrapper {
    background-color: rgb(235, 236, 240); }
  ...
  .u-tree .u-tree-treenode-disabled > span.u-tree-node-content-wrapper,
  .u-tree .u-tree-treenode-disabled > span.u-tree-node-content-wrapper span {
    color: #909090;
    cursor: not-allowed; }
    .u-tree .u-tree-treenode-disabled > span:hover,
    .u-tree .u-tree-treenode-disabled > span.u-tree-node-content-wrapper:hover,
    .u-tree .u-tree-treenode-disabled > span.u-tree-node-content-wrapper span:hover {

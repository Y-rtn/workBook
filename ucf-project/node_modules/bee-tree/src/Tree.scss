...
.u-tree {
  ...
  .u-tree-checkbox-checked .u-tree-checkbox-inner:after {
      ...
      width: 5px;
      height: 8px;
      border: 2px solid $tree-checkbox-color;
      border-top: 0;
      border-left: 0;
      content: ' ';
  ...
  li.filter-node > span.u-tree-node-content-wrapper {
    color: #f50;
    font-weight: bold;
  }
  li ul {
  ...
  li span.u-tree-node-content-wrapper {
    display: inline-block;
    padding: 3px 4px;
    border-radius: 2px;
    margin: 0;
  ...
  li span.u-tree-node-content-wrapper:hover {
    background-color: $tree-node-bg-color;
  }
  li span.u-tree-node-selected {
    background-color: $selected-bg-color-base;
    .u-tree-title{
      color: $brand-primary;
    }
  }
  li.u-tree-treenode-focused>span.u-tree-node-content-wrapper{
    background-color: $tree-node-bg-color;
  }
  li span.u-checkbox {
    margin: 2px 4px 0 0;
  ...
  .u-tree-treenode-disabled > span.u-tree-node-content-wrapper,
  .u-tree-treenode-disabled > span.u-tree-node-content-wrapper span {
    color: #909090;
    cursor: not-allowed;
    &:hover{

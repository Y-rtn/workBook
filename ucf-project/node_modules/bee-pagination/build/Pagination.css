...
.u-pagination {
  ...
  .u-pagination-list {
    ...
    .u-pagination-list.u-pagination-gap > li.u-pagination-item-ellipsis > a {
      border: none;
      padding: 0; }
  ...
  .u-pagination .data_per_select {
    ...
    .u-pagination .data_per_select .u-select {
      ...
      .u-pagination .data_per_select .u-select .u-select-selection {
        ...
        border-color: #E4E4E4;
        color: #666; }
        .u-pagination .data_per_select .u-select .u-select-selection:hover {
          border-color: #ADB4BC; }
        .u-pagination .data_per_select .u-select .u-select-selection .u-select-selection-rendered {
          line-height: 32px; }
  .u-pagination-data_per_select .u-select-dropdown-menu-item:not(.u-select-dropdown-menu-item-selected) {
    color: #666; }
    .u-pagination-data_per_select .u-select-dropdown-menu-item:not(.u-select-dropdown-menu-item-selected):hover {
      background-color: #F8F9FD; }
  .u-pagination-data_per_select .u-select-dropdown-menu-item-selected, .u-pagination-data_per_select .u-select-dropdown-menu-item-selected:hover {
    color: #666; }

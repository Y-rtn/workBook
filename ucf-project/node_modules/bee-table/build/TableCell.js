...
var propTypes = {
  ...
  bodyDisplayInRow: _propTypes2["default"].any,
  stopRowDrag: _propTypes2["default"].func,
  lazyStartIndex: _propTypes2["default"].number,
  lazyEndIndex: _propTypes2["default"].number,
  ...
  function TableCell(props) {
    ...
    _this.renderLinkType = function (data, record, index) {
      ...
      if (linkUrl) {
        ...
        var cls = prefix + '-table-link ' + prefix + '-table-fieldtype ';
        if (className) {
          cls += className + ' ';
        }
        if (underline) {
    ...
    _this.renderNumber = function (data) {
      ...
      var res = _react2["default"].createElement(
        'span',
        { className: prefix + '-table-currency-number' },
        number
      );
      var pre = preSymbol ? _react2["default"].createElement(
        'span',
        { className: prefix + '-table-currency-pre' },
        preSymbol
      ) : null;
      var next = nextSymbol ? _react2["default"].createElement(
        'span',
        { className: prefix + '-table-currency-next' },
        nextSymbol
      ) : null;
      var title = '';
      ...
      return _react2["default"].createElement(
        'span',
        { className: prefix + '-table-currency ' + prefix + '-table-fieldtype', style: { width: numberWidth }, title: title },
        pre,
        res,
        next
      );
    ...
    _this.renderColumnMenu = function (colMenu, text, record, index) {
      ...
      var iconClassName = prefix + '-table-inline-op-icon ' + prefix + '-table-inline-op-icon-hover';
      return _react2["default"].createElement(

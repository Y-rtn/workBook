...
.u-table {
  ...
  .u-table-scroll {
    overflow: auto; }
  .u-table-scroll .u-table-body table {
    overflow: hidden; }
  .u-table-bordered .u-table-content {
    border-left: 0;
  ...
  .u-table-bordered td {
    ...
    box-sizing: border-box; }
  .u-table-bordered .u-table-fixed-right {
    border-left: 1px solid rgb(193, 199, 208); }
  .u-table-bordered .u-table-scroll tr td:first-child, .u-table-bordered .u-table-scroll tr th:first-child, .u-table-bordered .u-table-fixed-left tr td:first-child, .u-table-bordered .u-table-fixed-left tr th:first-child {
    border-left: 1px solid rgb(193, 199, 208); }
  .u-table-bordered .u-table-footer {
  ...
  .u-table-thead th {
    ...
    .u-table-thead th .required {
      color: #F22C1D; }
    .u-table-thead th .u-table-column-sorter {
      position: relative;
      margin-left: 4px;
      height: 16px;
      ...
      display: inline-block;
      margin-top: -3px; }
      .u-table-thead th .u-table-column-sorter i {
        padding: 0px;
        font-weight: 600;
        color: #505F79; }
      .u-table-thead th .u-table-column-sorter > .u-table-column-sorter-down,
      .u-table-thead th .u-table-column-sorter > .u-table-column-sorter-up, .u-table-thead th .u-table-column-sorter > .u-table-column-sorter-flat {
        line-height: 16px;
        display: block;
        width: 34px;
        cursor: pointer; }
    .u-table-thead th .u-table-column-sorter-down.on .uf-triangle-down,
    .u-table-thead th .u-table-column-sorter-down.on .uf-triangle-up,
    .u-table-thead th .u-table-column-sorter-up.on .uf-triangle-down,
    .u-table-thead th .u-table-column-sorter-up.on .uf-triangle-up {
      color: #108ee9; }
    .u-table-thead th .u-table-column-sorter .uf-triangle-down,
    .u-table-thead th .u-table-column-sorter .uf-triangle-up {
      -webkit-filter: none;
      filter: none;
      font-size: 12px; }
    .u-table-thead th .u-table-column-sorter .uf-triangle-down,
    .u-table-thead th .u-table-column-sorter .uf-triangle-up {
      ...
      height: 4px;
      color: #999; }
    .u-table-thead th:hover .u-table-column-sorter {
      display: inline-block; }
  ...
  .u-table-thead-th {
    ...
    .u-table-thead-th-drag-gap {
      ...
      .u-table-thead-th-drag-gap .online-hover {
        background: #000000; }
      .u-table-thead-th-drag-gap:not(.left).last {
        right: 0; }

...
function sort(Table, Icon) {
  ...
  return _temp = _class = function (_Component) {
    ...
    function SortTable(props) {
      ...
      var flatColumns = _this2._toFlatColumn(props.columns, -1);
    ...
    SortTable.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.columns !== this.props.columns) {
        var flatColumns = this._toFlatColumn(nextProps.columns, -1);
    ...
    SortTable.prototype.render = function render() {
      ...
      return _react2["default"].createElement(Table, _extends({}, this.props, { columns: columns, data: this.state.data, onDropBorder: this.handleDropBorder }));
    };

    return SortTable;
  }(_react.Component), _class.defaultProps = { prefixCls: prefix + '-table', sort: { mode: "single", backSource: false } }, _class.propTypes = {
    ...
    this._initSort = function () {
      ...
      if (needSort) {
        if (sort && !sort.backSource && sort.mode !== "single") {
          //多列排序情况下数据排序
    ...
    this.sortColumn = function (column) {
      ...
      if (column.sorter || column.sortEnable) {
        ...
        sortButton = _react2["default"].createElement(
          'div',
          { className: prefix + '-table-column-sorter' },
          _react2["default"].createElement(
            'span',
            { className: prefix + '-table-column-sorter-' + sorterClass, onClick: function onClick() {
    ...
    this.handleDropBorder = function (event, newWidth, newColumn, newColumns) {
      var onDropBorder = _this3.props.onDropBorder;

      var flatColumn = _this3.state.flatColumns.find(function (column) {
        return column.dataIndex == newColumn.dataIndex;
      });
      flatColumn.width = newWidth;
      _this3.setState({ flatColumns: _this3.state.flatColumns });
